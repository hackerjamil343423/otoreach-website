            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-light hover:border-accent-lime/40 transition-all duration-700 shadow-sm hover:shadow-accent-lime/20 animate-fade-in-up text-center">
                <div className="mb-6 flex justify-center">
                  <img src="/landing-page/images/element-analytics.png" alt="البحث والتحليل" className="w-32 h-32 object-contain" />
                </div>
              ...
              <div className="bg-white rounded-3xl p-8 border border-gray-light hover:border-accent-lime/40 transition-all duration-700 shadow-sm hover:shadow-accent-lime/20 animate-fade-in-up text-center">
                <div className="mb-6 flex justify-center">
                  <img src="/landing-page/images/element-copy.png" alt="المحتوى" className="w-32 h-32 object-contain" />
                </div>
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-light hover:border-accent-lime/40 transition-all duration-700 shadow-sm hover:shadow-accent-lime/20 animate-fade-in-up text-center">
                <div className="mb-6 flex justify-center">
                  <img src="/landing-page/images/element-design.png" alt="التصميم" className="w-32 h-32 object-contain" />
                </div>
              ...
              <div className="bg-white rounded-3xl p-8 border border-gray-light hover:border-accent-lime/40 transition-all duration-700 shadow-sm hover:shadow-accent-lime/20 animate-fade-in-up text-center">
                <div className="mb-6 flex justify-center">
                  <img src="/landing-page/images/element-speed.png" alt="السرعة" className="w-32 h-32 object-contain" />
                </div>
