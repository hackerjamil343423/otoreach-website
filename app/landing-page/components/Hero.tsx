          ...
          <div className="flex flex-col items-center justify-center gap-8 animate-fade-in-up">
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
              <a href="/landing-page/apply">
                <button className="bg-accent-lime hover:bg-accent-lime-hover text-charcoal px-8 sm:px-12 py-4 sm:py-5 rounded-full font-bold text-lg sm:text-xl transition-all duration-300 shadow-md hover:shadow-lg inline-flex items-center group w-full sm:w-auto">
                  احجز استشارة مجانية
